...
class HelloApiView(APIView):
    ...
    def get(self, request, format=None):
        ...
        an_apiview = [
            ...
            'Gives you the mot control over your application logic',
            'I mapped manually to URLs'
        ]
    ...
    def put(self, request, pk=None):#replacing an object
        """Handle updating an object"""
        return Respone({'method': 'PUT'})

    def patch(self, request, pk=None): #updates one of the object
...
class HelloViewSet(viewsets.ViewSet):
    ...
    def list(self, request):
        ...
        a_viewset = [
            'Uses actions (lis, create, retrieve, update, partial_update)',
